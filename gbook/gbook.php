...
<ul class="lists">
    <?
    $sql = " select * from guestbook order by id desc ";//oder by:정렬 desc:역순
...
<section class="write">
    <form name="g_form" method="post" action="gbook_ok.php">
        ...
        <div>
            <textarea class="w3-input w3-border" name="content" id="content" placeholder="방명록을 작성해 주세여/"></textarea>
        </div>
        <div>
